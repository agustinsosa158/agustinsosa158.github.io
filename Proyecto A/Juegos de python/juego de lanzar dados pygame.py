...
fondo = pygame.image.load(f"C:/Users/NoxiePC/Desktop/Juego dados/fondomesa.png")
...
pygame.mixer.music.load(f"C:/Users/NoxiePC/Desktop/Juego dados/Musica de fondo tranquila.mp3")
pygame.mixer.music.set_volume(0.1)
pygame.mixer.music.play(-1)

# Carga de imágenes de dados (ajusta la ruta si es necesario)
imagenes_dados = [pygame.image.load(f"C:/Users/NoxiePC/Desktop/Juego dados/dados/dado{i}.png") for i in range(1, 7)]
...
def evaluar_ronda():
    ...
    if jugador_suma > 10 and cpu_suma >10:
        ...
        resultado = "La CPU se pasó. ¡Ganaste!"
    else:
